...
SECRET_KEY = 'django-insecure-t3c-*(j58i&_-li=^s4p1t8wdy3gqo@piv7&vi-!n0n#i==)cm'
...
DATABASES = {
    "default": {
        ...
        "PORT": "5432",
        "OPTIONS" :{
            "options": "-c search_path=payment_service,public"
            },
    }
}
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'Payment.authentication.JWTAuthentication',  # your custom class
    ],
